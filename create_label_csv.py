...
folders_train =['Front_CAM/A/', 'Front_CAM/B/', 'Front_CAM/C/', 'Front_CAM/D/', 'Front_CAM/E/', 'Front_CAM/F/',
...
folders_valid = ['Below_CAM/A/', 'Below_CAM/B/', 'Below_CAM/C/', 'Below_CAM/D/', 'Below_CAM/E/', 'Below_CAM/F/',
